...
product_description_table = Table(
    ...
    Column('product_dimensions_id', ForeignKey('product_dimensions.id', ondelete='CASCADE')),
    Column('product_periodicity_id', ForeignKey('product_periodicity.id', ondelete='CASCADE'))
)